...
func SagaStep[E Event[T], C Command[U], T Aggregatable, U Aggregatable](ctx context.Context, sub Projector[T], cmd Executer[U], shf sagaHandlerFunc[E, C, T, U], opts ...sagaOption[E, C, T, U]) {
